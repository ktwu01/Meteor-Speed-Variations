...
load('../../Data/MCMR_MetData_2014_2023.mat','azimuth','doy','localtime','mcest','speed');
...
% print(gcf,['WKTazi_lt_surf_con_1_4p_V1_5'],'-dpng','-r600');
% saveas(gcf,['Figure4'],'epsc');
% saveas(gcf,'WKTazi_lt_surf_con_1_4p_V1_5','svg')
disp('Fig:WKTazi_lt_surf_con_1_4p_V1_5 Saved.')
