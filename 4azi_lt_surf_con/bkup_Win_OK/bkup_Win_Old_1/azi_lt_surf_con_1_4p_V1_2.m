...
subplot(rows,cols,axs{2});az_lt_contourf(id_pr,localtime, azimuth, 1);title('Jan 4');    ylabel('Azimuth (degree)');
...
subplot(rows,cols,axs{3});az_lt_contourf(id_se,localtime, azimuth, 2);title('Apr 4')
%     axx = gca;
%     setfont(fs);
%     set(gca,'linewi',0.5,'tickdir','out');
%     hold on; nph_text([-0.150 1.10],['(' alphabet(3) ')'],'fontsize',1.5*fs);
% 
subplot(rows,cols,axs{4});az_lt_contourf(id_ap,localtime, azimuth, 3);title('Jul 4')
%     axx = gca;
%     setfont(fs);
%     set(gca,'linewi',0.5,'tickdir','out');
%     hold on; nph_text([-0.150 1.10],['(' alphabet(4) ')'],'fontsize',1.5*fs);

subplot(rows,cols,axs{5});az_lt_contourf(id_ae,localtime, azimuth, 4);title('Oct 2')
%     axx = gca;
%     setfont(fs);
%     set(gca,'linewi',0.5,'tickdir','out');
...
saveas(gcf,'WKTazi_lt_surf_con_1_4p_V1_2','png')
% saveas(gcf,'WKTazi_lt_surf_con_1_4p_V1_2','epsc')
% saveas(gcf,'WKTazi_lt_surf_con_1_4p_V1_2','fig')
disp('Fig:WKTazi_lt_surf_con_1_4p_V1_2 Saved.')
