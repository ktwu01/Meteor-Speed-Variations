...
subplot(rows,cols,axs{2});azidtdis1=az_lt_contourf(id_pr,localtime, azimuth, 1);title('Jan 4')
%     axx = gca;
%     setfont(fs);
%     set(gca,'linewi',0.5,'tickdir','out');
...
saveas(gcf,'WKTazi_lt_surf_con_1_4p_V1','png')
% saveas(gcf,'WKTazi_lt_surf_con_1_4p_V1','epsc')
% saveas(gcf,'WKTazi_lt_surf_con_1_4p_V1','fig')
disp('Fig:WKTazi_lt_surf_con_1_4p_V1 Saved.')
