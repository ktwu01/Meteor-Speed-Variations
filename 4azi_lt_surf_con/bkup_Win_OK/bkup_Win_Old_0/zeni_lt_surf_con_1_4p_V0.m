...
saveas(gcf,'WKTzeni_lt_surf_con_1_4p_V0','png')
% saveas(gcf,'WKTzeni_lt_surf_con_1_4p_V0','epsc')
% saveas(gcf,'WKTzeni_lt_surf_con_1_4p_V0','fig')
disp('Fig:WKTzeni_lt_surf_con_1_4p_V0 Saved.')
